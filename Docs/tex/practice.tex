...
Приведём ещё насколько примеров для построения сеток на шестигранниках, изображённых на рисунках в таблице \ref{tab:figures}.

\begin{table}
	\caption{Примеры сеток на шестигранниках}
	\centering
	\small
	\begin{tabular}{|p{3.5cm}|c|c|}
		\hline
		\centering{Фигура} & \centering{Расчётная область} & \centering{Сетка} \tabularnewline \hline
		
		
		Изумруд & 
			\includegraphics[width=0.35\linewidth]{images/EmeraldField.png}  & \includegraphics[width=0.35\linewidth]{images/EmeraldMesh.png} \tabularnewline \hline
		
		Скошенная пирамида &  &  \tabularnewline \hline
		
		Песочные часы &  &  \tabularnewline \hline
		
		Ванная &  &  \tabularnewline \hline
		
		Детализированный изумруд &  &  \tabularnewline \hline
		
		Случайная фигура &  &  \tabularnewline \hline
